...
const maintenanceData = [
	{
		title: "숙명여자대학교",
		details: ["메인페이지 열람실 좌석현황 반응형 텍스트 간격 및 사이즈 조정", "테이블 툴팁 추가"],
	},
	{
		title: "우석대학교",
		details: ["(학술DB/전자저널) 국외 탭 전주/진천(국문/영문/베트남/우즈벡) 리스트 추가 및 수정"],
	},
	{
		title: "홍익대학교",
		details: ["메인페이지 배너 섹션 롤링형태로 변경 html,css,script 추가"],
	},
	{
		title: "가톨릭대 성심교정",
		details: ["메인 페이지 베너 부분 더보기 아이콘 추가"],
	},
	{
		title: "가톨릭대 성의교정",
		details: ["메인 슬라이드 배너 섹션 정지/시작 dots 추가"],
	},
	{
		title: "삼육대학교",
		details: ["자료구입신청 페이지 이용안내 테이블 추가"],
	},
	{
		title: "광주대학교",
		details: ["국내학술 DB / OA 신규페이지 테이블 코딩", "국내학술DB 수정 및 추가 및 송부"],
	},
	{
		title: "아산의학도서관",
		details: ["main,sub 반응형 푸터 sns 아이콘 추가"],
	},
	{
		title: "단국대학교",
		details: [
	...
	},
	{
		...
		details: ["조직도 ＇출판부＇ 삭제로 인한 화면 틀어짐 수정"],
	},
	{
		title: "순천향대학교",
		details: ["메인 페이지 베너 이미지 추가 및 css 수정"],
	},
	{
		title: "서울시립대학교",
		details: ["메인 배너 반응형시 이미지 찌그러지는 현상 css 수정"],
	},
	{
		title: "동명대학교",
		details: ["Turnitin(턴잇인) 신규 페이지 퍼블리싱", "메인페이지 검색어 tab 부분 css 조정"],
	},
	{
		title: "동국대학교",
		details: ["이용안내 이미지 수정 및 텍스트 수정"],
	},
	{
		title: "삼성서울병원",
		details: [
	...
	},
	{
		...
		details: ["개인정보처리방침 리뉴얼 퍼블리싱", "개인정보처리방침 테이블 간격 조정 & 텍스트 조정"],
	},
	{
		title: "서강대학교",
		details: ["신규 페이지 퍼블리싱 라파엘 라이브 스튜디오 (촬영스튜디오, 편집실) 이용안내"],
	},
	{
		title: "연세대학교 통합형 전자도서관",
		details: ["4F 평면도 이미지 수정 및 텍스트 변경", "학술정보교육실 신규 html 페이지 퍼블리싱"],
	},
	{
		title: "국민건강보험공단",
		details: ["메인페이지 푸터 개인정보처리방침 메뉴 추가"],
	},
	{
		title: "KDI국제정책대학원",
		details: ["전자도서이용안내페이지 테이블 퍼블리싱", "테이블 반응형 퍼블리싱"],
	},
	{
		title: "충남대학교",
		details: [
	...
	{
		title: "한국해양대학교",
		details: ["게시판  이미지 첨부관련 이슈 (업로드 시) 스크립트 수정"],
	},
	{
		title: "이천시 공공도서관",
		details: ["구독형 전자책 html 페이지 퍼블리싱", "구독형 전자책 페이지 레이아웃 틀어짐 수정"],
	},
	{
		title: "한국국제협력단(KOICA)",
		details: ["메인 베너 riss 로고 이미지 변경"],
	},
	{
		title: "한국전력공사",
		details: ["회원가입약관 텍스트 간격 조정 및 전체동의 스크립트 생성"],
	},
	{
		title: "선문대학교",
		details: ["메인 페이지 메뉴 틀어짐 css 수정"],
	},
	{
		title: "대전시 유성구 관평도서관",
		details: [
	...
	{
		title: "연세대학교 통합형 전자도서관",
		details: ["도서관 컨시어지 서비스 신규 이용안내 페이지 퍼블리싱"],
	},
	{
		title: "동신대학교",
		details: ["메인페이지 이용시간안내 간격 수정", "메인페이지 quick menu 간격 및 디자인 css 수정"],
	},
	{
		title: "경성대학교 웹표준기반전저도서관시스템",
		details: ["이용안내 페이지 테이블 간격 조정"],
	},
	{
		title: "LG화학 연구소",
		details: [
	...
	{
		title: "한국국제협력단(KOICA)",
		details: ["header 디자인 및 header 간격 위치 수정"],
	},
	{
		title: "동양미래대학",
		details: ["통합검색페이지 반응형 레이아웃 수정 및 텍스트 및 폰트사이즈 틀어짐 수정"],
	},
	{
		title: "한글박물관",
		details: ["header 상단 메뉴 height 조절"],
	},
	{
		title: "연세대학교 통합형 전자도서관",
		details: [
	...
	{
		title: "부산가톨릭대학교",
		details: ["교재현황 페이지 검색어 영역 z-index 조정"],
	},
	{
		title: "인천글로벌캠퍼스",
		details: ["메인페이지 아이콘 사이즈 조절"],
	},
	{
		title: "인권도서관 인권자료관리시스템",
		details: [
...
const projectData2 = [
	...
	{
		name: "한국교육과정평가원 학업성취도 컴퓨터 기반 평가시스템 구축(2차연도)",
		link: "https://inaea.kice.re.kr/siteMain/index.do#main1",
	},
...
const projectData3 = [{ name: "오픈소스 관리 포털 내부 시스템 구축", link: "", internal: true }];
						...
						<div className="experienceBox">
							<div className="boxInner">
								<div className="boxTit">
									<h3>
										<span className="companyN">(주)프로젝트 독</span>{" "}
									...
									<ul className="projectList">
										{projectData1.map((project, index) => (
											<li key={index}>
												...
												{project.link && (
													<a href={project.link} target="_blank" className="siteView">
														<span>바로가기</span>
													</a>
												)}
											</li>
					...
					<div className="stickyBox num2">
						<div className="experienceBox">
							<div className="boxInner">
								<div className="boxTit">
									<h3>
										<span className="companyN">(주)퓨쳐누리</span>{" "}
					...
					<div className="stickyBox num3">
						<div className="experienceBox">
							<div className="boxInner">
								<div className="boxTit">
									<h3>
										<span className="companyN">NH 농협은행</span>{" "}
