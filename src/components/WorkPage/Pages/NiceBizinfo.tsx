		...
		<div className="content">
			...
			<div className="reviewBox">
				<p>
					...
					필요했습니다.<br></br> 특히 SSR(Server Side Rendering) 환경에서 **웹 접근성 인증(마크)**을
					충족시키는 것은 쉽지 않은 과제였습니다. 하지만 Nuxt 3의 SSR 특성과 Quasar의 UI 컴포넌트를 활용하며,
					각 요소의 시맨틱 구조와 ARIA 속성을 세심하게 관리해 접근성 기준에 맞게 코드를 완성할 수 있었습니다.
					...
					<br></br> 결국 화면 설계부터 구축까지 어려운 상황 속에서도 프로젝트를 성공적으로 마무리할 수
					있었습니다. 이번 프로젝트를 통해 초기 설계, 코드 품질, 웹 접근성 고려의 중요성을 다시 한 번 체감할
					수 있었고, 복잡한 상황을 체계적으로 해결하며 성장할 수 있는 값진 경험이 되었습니다.
				</p>
			</div>
		</div>
	</div>
